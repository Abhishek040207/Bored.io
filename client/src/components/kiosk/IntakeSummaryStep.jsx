  ...
  return (
    <div className="max-w-4xl mx-auto py-6 px-4">
      ...
      <div className="text-center space-y-3 mb-8">
        <div className="w-16 h-16 rounded-full bg-emerald-500/20 text-emerald-400 border-2 border-emerald-500/40 flex items-center justify-center mx-auto shadow-xl shadow-emerald-500/10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="lg:col-span-1 bg-gradient-to-b from-slate-900 via-slate-950 to-slate-900 border-2 border-emerald-500/50 rounded-3xl p-6 shadow-2xl relative overflow-hidden flex flex-col justify-between">
          ...
          <div className="space-y-4">
            <div className="text-center border-b border-dashed border-slate-700 pb-4">
              ...
              <div className="text-xs text-slate-400">Primary Health Centre • OPD Slip</div>
            </div>

            {/* Token Number Highlight */}
            <div className="text-center py-3 bg-slate-900/90 rounded-2xl border border-slate-800">
              <div className="text-xs text-slate-400 uppercase tracking-wider">
                {isHindi ? 'आपका टोकन नंबर' : 'Your Token Number'}
              </div>
              <div className="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-300 font-mono my-1">
                #{summaryResult?.token_number || '01'}
              </div>
              <div className="inline-block text-xs font-bold px-3 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
            ...
            <div className="space-y-2 text-xs text-slate-300">
              <div className="flex justify-between py-1 border-b border-slate-800/80">
                ...
                <span className="font-semibold text-white">{patient?.name || 'Citizen'}</span>
              </div>
              <div className="flex justify-between py-1 border-b border-slate-800/80">
              ...
              <div className="flex justify-between py-1 border-b border-slate-800/80">
                ...
                <span className="font-mono text-emerald-400">{patient?.abha_number || '91-5043-5666-3218'}</span>
              </div>
              <div className="flex justify-between py-1 border-b border-slate-800/80">
            ...
            {/* QR Code Graphic */}
            <div className="p-3 bg-slate-950 rounded-xl border border-slate-800 text-center flex flex-col items-center">
              <MdQrCode size={48} className="text-slate-300" />
          ...
          <button
            type="button"
            onClick={handlePrint}
            className="mt-4 w-full py-2.5 px-4 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold flex items-center justify-center gap-2 border border-slate-700 transition-colors"
          >
            <FiPrinter size={14} />
        ...
        <div className="lg:col-span-2 bg-slate-900/90 border border-slate-800 rounded-3xl p-6 md:p-8 space-y-6 shadow-2xl backdrop-blur-md flex flex-col justify-between">
          <div className="space-y-4">
            {/* Audio summary card */}
            <div className="p-4 rounded-2xl bg-gradient-to-r from-emerald-950/40 via-slate-900 to-slate-950 border border-emerald-500/30 flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <button
                  type="button"
                  onClick={handleToggleAudio}
                  className="p-3 rounded-xl bg-emerald-500 text-slate-950 font-bold hover:scale-105 active:scale-95 transition-all shrink-0"
                >
                  <FiVolume2 size={20} />
                </button>
                <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-blue-400 bg-blue-500/10 px-2.5 py-0.5 rounded-full border border-blue-500/30">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-h-80 overflow-y-auto pr-1">
                ...
                <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800">
                  <span className="text-[10px] font-bold text-blue-400 uppercase">1. Chief Complaint</span>
                ...
                {/* 2. HPI */}
                <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800">
                  <span className="text-[10px] font-bold text-emerald-400 uppercase">2. History of Present Illness</span>
                ...
                <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800">
                  <span className="text-[10px] font-bold text-purple-400 uppercase">3. Past Medical / Surgical</span>
                ...
                {/* 4. Drug & Allergy */}
                <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800">
                  <span className="text-[10px] font-bold text-orange-400 uppercase">4. Drug & Allergy History</span>
                  <p className="text-xs text-slate-300 mt-1">
                ...
                {/* 5. Family History */}
                <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800">
                  <span className="text-[10px] font-bold text-pink-400 uppercase">5. Family History</span>
                  <p className="text-xs text-slate-300 mt-1">
                ...
                {/* 6. Personal History */}
                <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800">
                  <span className="text-[10px] font-bold text-yellow-400 uppercase">6. Personal History</span>
                  <p className="text-xs text-slate-300 mt-1">
                ...
                {/* 7. Review of Systems */}
                <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800">
                  <span className="text-[10px] font-bold text-teal-400 uppercase">7. Review of Systems (ROS)</span>
                ...
                <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800">
                  <span className="text-[10px] font-bold text-indigo-400 uppercase">8. Prior Investigations</span>
                  <p className="text-xs text-slate-300 mt-1">
          ...
          <div className="pt-4 border-t border-slate-800 flex items-center justify-between">
            ...
            <button
              ...
              className="py-3.5 px-8 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-slate-950 font-bold text-base shadow-xl shadow-emerald-500/20 hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
            >
              <FiHome size={18} />
